...
class Docter(Base):
    ...
    day_work_time = Column(TEXT, nullable=True)
    day_rest_time = Column(TEXT, nullable=True)
    sat_work_time = Column(TEXT, nullable=True)
    sun_work_time = Column(TEXT, nullable=True)
